...
export const CATEGORY_PRODUCTS = {
  'bedrooms': [
    { id: 1001, name: 'The Phoenician Master Suite', price: 4200, dimensions: 'Custom', image: Bedroom_1, tag: 'Premium', material: 'Walnut', category: 'Bedrooms', categoryId: 'bedrooms', description: 'A luxurious master bedroom set featuring a grand headboard and integrated nightstands, inspired by ancient Phoenician craftsmanship.' },
    ...
    { id: 1003, name: 'Mount Lebanon Cedar Wardrobe', price: 3200, dimensions: '240 x 60 x 220 cm', image: Bedroom_3, tag: null, material: 'Cedar', category: 'Bedrooms', categoryId: 'bedrooms', description: 'Spacious wardrobe crafted from aromatic cedar with traditional joinery.' },
    { id: 1004, name: 'Aura Vanity Collection', price: 1800, dimensions: '120 x 45 cm', image: Bedroom_4, tag: 'Popular', material: 'Maple', category: 'Bedrooms', categoryId: 'bedrooms', description: 'A sophisticated vanity with a large mirror and ample storage for essentials.' },
    { id: 1005, name: 'Urban Guest Haven', price: 2100, dimensions: 'Custom', image: Bedroom_5, tag: null, material: 'Pine', category: 'Bedrooms', categoryId: 'bedrooms', description: 'Perfect for smaller rooms, offering comfort and style without compromise.' },
  ],
  'tv-units': [
    { id: 2001, name: 'Levant Floating Console', price: 1400, dimensions: '200 x 40 cm', image: Tv_1, tag: 'Best Seller', material: 'Walnut', category: 'TV Units', categoryId: 'tv-units', description: 'Sleek floating design that hides all cables for a clean, modern look.' },
    ...
    { id: 2005, name: 'Rhythm Slatted Unit', price: 1350, dimensions: '190 x 42 cm', image: Tv_5, tag: 'Popular', material: 'Oak', category: 'TV Units', categoryId: 'tv-units', description: 'Features beautiful vertical slats that allow remote signals to pass through.' },
    { id: 2006, name: 'Vantage Corner Unit', price: 850, dimensions: '120 x 40 cm', image: Tv_6, tag: null, material: 'Pine', category: 'TV Units', categoryId: 'tv-units', description: 'Designed to fit perfectly in corners, maximizing space in smaller rooms.' },
    { id: 2007, name: 'Carrara & Walnut Media Unit', price: 2800, dimensions: '220 x 45 cm', image: Tv_7, tag: 'Premium', material: 'Walnut & Marble', category: 'TV Units', categoryId: 'tv-units', description: 'Exquisite walnut base topped with premium Italian marble.' },
    { id: 2008, name: 'Heritage Rustic Stand', price: 980, dimensions: '170 x 48 cm', image: Tv_8, tag: null, material: 'Reclaimed Wood', category: 'TV Units', categoryId: 'tv-units', description: 'Warm, rustic charm with plenty of character and storage.' },
    { id: 2009, name: 'Onyx Glass Console', price: 1500, dimensions: '200 x 40 cm', image: Tv_9, tag: null, material: 'Black Oak', category: 'TV Units', categoryId: 'tv-units', description: 'Modern black oak finish with smoked glass doors.' },
    { id: 2010, name: 'Gatsby Media Console', price: 1900, dimensions: '180 x 42 cm', image: Tv_10, tag: 'New', material: 'Mahogany', category: 'TV Units', categoryId: 'tv-units', description: 'Elegant Art Deco inspired design with gold hardware.' },
    { id: 2011, name: 'Nordic Media Bench', price: 1050, dimensions: '150 x 40 cm', image: Tv_11, tag: null, material: 'Light Oak', category: 'TV Units', categoryId: 'tv-units', description: 'Simple, functional, and beautiful Scandinavian design.' },
  ],
  'sofas': [
    ...
    { id: 3002, name: 'Modern Leather Sofa', price: 3200, dimensions: '220 x 95 cm', image: S_2, tag: 'Premium', material: 'Top Grain Leather', category: 'Sofas', categoryId: 'sofas', description: 'Timeless leather sofa that ages beautifully and fits any decor.' },
    ...
    { id: 3004, name: 'Compact 2-Seater', price: 1200, dimensions: '160 x 85 cm', image: S_4, tag: null, material: 'Cotton Blend', category: 'Sofas', categoryId: 'sofas', description: 'Perfect for apartments or as an accent piece in larger rooms.' },
    { id: 3005, name: 'Modular Cloud Sofa', price: 4500, dimensions: 'Custom', image: S_5, tag: 'Popular', material: 'Performance Fabric', category: 'Sofas', categoryId: 'sofas', description: 'Fully modular system that can be configured to fit any space.' },
    { id: 3006, name: 'Classic Tufted Sofa', price: 2400, dimensions: '210 x 90 cm', image: S_6, tag: null, material: 'Velvet', category: 'Sofas', categoryId: 'sofas', description: 'Elegant tufted backrest and rolled arms for a classic look.' },
  ],
  'tables': [
    ...
    { id: 4004, name: 'Factory Side Table', price: 380, dimensions: '50 x 50 cm', image: Table_4, tag: null, material: 'Oak & Iron', category: 'Tables', categoryId: 'tables', description: 'Compact side table with a rugged industrial aesthetic.' },
    { id: 4005, name: 'Sequoia Live Edge Table', price: 1400, dimensions: '140 x 70 cm', image: Table_5, tag: 'Premium', material: 'Walnut', category: 'Tables', categoryId: 'tables', description: 'Unique live edge slab that brings the beauty of nature indoors.' },
    { id: 4006, name: 'Essential Console', price: 650, dimensions: '120 x 35 cm', image: Table_6, tag: 'Popular', material: 'Ash', category: 'Tables', categoryId: 'tables', description: 'Slim profile table perfect for entryways or behind sofas.' },
  ...
  'consoles': [
    { id: 5001, name: 'Welcome Walnut Console', price: 1250, dimensions: '140 x 40 cm', image: C_1, tag: 'Best Seller', material: 'Walnut', category: 'Consoles', categoryId: 'consoles', description: 'A beautiful first impression for your home with ample storage.' },
    { id: 5002, name: 'Reflect Console', price: 1600, dimensions: '120 x 35 cm', image: C_2, tag: 'Premium', material: 'Glass & Wood', category: 'Consoles', categoryId: 'consoles', description: 'Reflective surfaces that make your entryway feel larger and brighter.' },
    { id: 5003, name: 'Country Hallway Table', price: 820, dimensions: '130 x 38 cm', image: C_3, tag: null, material: 'Pine', category: 'Consoles', categoryId: 'consoles', description: 'Warm and inviting rustic table with a distressed finish.' },
    { id: 5004, name: 'Steel Line Console', price: 700, dimensions: '110 x 30 cm', image: C_4, tag: 'New', material: 'Steel', category: 'Consoles', categoryId: 'consoles', description: 'Ultra-slim design for tight spaces and modern interiors.' },
    { id: 5005, name: 'Barogo Carved Console', price: 2100, dimensions: '150 x 45 cm', image: C_5, tag: null, material: 'Mahogany', category: 'Consoles', categoryId: 'consoles', description: 'Intricately carved details for a touch of traditional elegance.' },
    ...
    { id: 5007, name: 'Depot Storage Console', price: 950, dimensions: '120 x 40 cm', image: C_7, tag: null, material: 'Oak & Steel', category: 'Consoles', categoryId: 'consoles', description: 'Combines open shelving with closed storage for versatility.' },
    ...
    { id: 5010, name: 'Fjord Hall Table', price: 800, dimensions: '100 x 35 cm', image: C_9, tag: null, material: 'Light Oak', category: 'Consoles', categoryId: 'consoles', description: 'Simple, clean, and functional Scandinavian design.' },
  ],
  'dining-tables': [
