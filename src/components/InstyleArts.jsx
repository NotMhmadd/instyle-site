                    ...
                    return (
                      ...
                      >
                        <img
                          ...
                          className={`w-full h-full object-contain bg-white transition-transform duration-500 group-hover:scale-105 transition-opacity duration-700 ${loaded[painting.code] ? 'opacity-100' : 'opacity-0'}`}
                          loading="lazy"
